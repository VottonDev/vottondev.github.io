...
export default function Home() {
  ...
  <div>
    <Head>
      ...
      <meta name="keywords" content="votton, programming, software development, system administration" />
    ...
    <main>
        ...
        <div class="box">
          ...
          <ul>
            ...
            <li><a href="https://onepluscommunityserver.com">OnePlus Archive + OnePlusBot</a></li>
          ...
          <ul>
            <li>e-mail &mdash; <a href="mailto:votton@artificialtrading.io">votton@artificialtrading.io</a></li>
          ...
          <img src="img/lain.gif" alt="lain" height="420" draggable="false" class="lain" />
        </div>
