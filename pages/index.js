  ...
  media =
      ...
      <main>
        <div id="scanlines"></div>
              <div class = "box"><h1>Votton's Personal Website</h1>{" "} <
                  /div>
        <div class="box">
          <h2>Projects:</h2>
              <ul><li><a href = "https://kyouko.se">Kyouko.se /
              Kyot.me &
      mdash;
      Private file hosting</a>
            </li><li>
          <a href = "https://onepluscommunityserver.com">OnePlus Archive +
          OnePlusBot</a>
            </li><li>
          ...
          <h2>Contact details:</h2><ul><li>e - mail &
      mdash;
      {" "}<a href = "mailto:votton@artificialtrading.io">votton
      @artificialtrading.io</a>
            </li><li>twitter &
      mdash;
